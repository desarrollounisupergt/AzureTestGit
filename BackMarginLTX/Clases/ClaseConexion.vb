...
Public Class claseConexion
    ...
    'VERSION 1.7.10.032014

    Private conexion As MySqlConnection
    Private sConexion As String 'el string de conexion que se esta utilizando
    Private query As MySqlCommand
    Private queryStoredProc As New MySqlCommand 'se crea una nueva variable para no entorpecer el utilizado
...
#Region "--- Propiedades de la conexion ..."
    ...
    Private _bPooling As Boolean = False 'True
...
#Region "--- Funciones utilizados para inicializar la conexion hacia la base de datos ..."
    ...
    Public Sub InstanciarQuery()
        ...
        queryStoredProc = New MySqlCommand
    ...
    Public Sub BuscarConexionEnXml(ByVal nombrexml As String)
        ...
        Try
            ...
            dsconexion.ReadXml(Application.StartupPath + "\" & nombrexml)
    ...
    Public Function EjecutarStoredProc(ByVal _nombreStoredProc As String, _
        ...
        Try
            ...
            For Each elemento As ParametrosStoredP In parametros
                With elemento
                    tmpParametro = New MySqlParameter(.nombreParametro, .valorParametro)
