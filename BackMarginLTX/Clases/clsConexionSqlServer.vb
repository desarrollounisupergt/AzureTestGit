...
Public Class clsConexionSqlServer
    ...
    'VERSION 1.6.18.032013

    Private conexion As SqlConnection
    Private sConexion As String 'el string de conexion que se esta utilizando
    Private query As SqlCommand
    Private queryStoredProc As New SqlCommand 'se crea una nueva variable para no entorpecer el utilizado
    Private daDatos As SqlDataAdapter
...
#Region "--- Funciones utilizados para inicializar la conexion hacia la base de datos ..."
    ...
    Public Sub InstanciarQuery()
        ...
        queryStoredProc = New SqlCommand
        queryStoredProc.Connection = conexion

        daDatos = New SqlDataAdapter
    End Sub
    ...
    Private Sub AsignarDatosDConexion(ByVal dsconexion As DataSet)
        ...
        'SE AGREGA DLL DE ENCRIPTACION DE CADENA DE CONEXION ENERO 2021 LBOCH
        '*******************************************************************
...
#Region "--- Funciones de los stored Procs"
    ...
    Public Class ParametrosStoredP
        ...
        Public Sub New(ByVal _nombreParametro As String, _
                       ByVal _valorParametro As Object, _
                       ByVal _direccionParametro As ParameterDirection, _
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Function EjecutarStoredProc(ByVal _nombreStoredProc As String, _
        ...
        Try
            ...
            Dim tmpParametro As SqlParameter
            'agregamos todos los parametros 
            For Each elemento As ParametrosStoredP In parametros
                With elemento
                    tmpParametro = New SqlParameter(.nombreParametro, .valorParametro)
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Function EjecutarEscalarStoredProc(ByVal _nombreStoredProc As String, _
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Function LlenarDatasetStoredProc(ByVal _nombreStoredProc As String, _
                                            ByVal _nombreTabla As String, _
    ...
    ''' <remarks></remarks>
    Public Sub LlenarDatasetStoredProc(ByVal _nombreStoredProc As String, _
                                       ByVal _nombreTabla As String, _
...
#Region "--- Funciones para ejecutar el DataReader"
    ...
    Private _drLector As SqlDataReader
    Public ReadOnly Property drLector() As SqlDataReader
        Get
            Return _drLector
        End Get
    End Property
    ...
    Public Sub AumentarTiempoServerReader(ByVal tiempo_escritura As Integer, ByVal tiempo_lectura As Integer)
        ...
        'nuestro server...
        EjecutarNonQuery("set net_write_timeout=" & tiempo_escritura & "; " & _
    ...
    ''' <param name="parametros"></param>
    ''' <remarks></remarks>
    Public Sub iniciarDataReaderStoredProc(ByVal _nombreStoredProc As String, _
                                            ByVal ParamArray parametros() As ParametrosStoredP)
